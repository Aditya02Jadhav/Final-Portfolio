          ...
          <div className="flex flex-col items-start justify-center max-w-lg space-y-6">
            ...
            <a href="/Aaditya Resume.pdf" download="Aaditya_Resume.pdf">
              <MagicButton
                ...
                position="right"
                otherClasses="text-[#f54242] dark:text-[#f54242] border-[#f54242] dark:border-[#f54242] hover:bg-[#f54242] hover:text-white dark:hover:bg-[#f54242] dark:hover:text-black"
              />
            </a>
          </div>
